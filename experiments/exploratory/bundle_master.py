...
from isac_sim.sensing.model import BaseGains, LinkTables, rescale_sensing_tables_for_rcs
from isac_sim.cooperation.reporting import ReportingPlan, is_local_observation
...
def _bundle_within_caps(
    ...
    return not (
        (0 <= local_cap < local)
        or (0 <= fusion_cap < processing)
        or (0 <= report_cap < remote)
