...
from experiments.flow.sweeps import EXPERIMENTS, EXPERIMENT_NAMES, VALUE_MODES, prior_sweep, robustness
from experiments.app.plotting import PLOTTERS, plot_main_comparison
from experiments.app.report import print_summary, write_csv, write_main_summary_latex, write_rows_csv
...
DESCRIPTIONS: Dict[str, str] = {
    ...
    "interference-consistency": "communication/sensing interference coupling (near-far bookkeeping)",
}

# 曾有一条 ``direct_cancellation`` 轴扫 ``interference.direct_cancellation_db``。
# 那个字段已删除（没有接收机实现支撑却撑着 SINR 的分母），故该轴退役。
